...
if __name__ == '__main__':
    ...
    with Pool(5) as pool:
        result = pool.map(sampleMicrostates, args)


    print("Total states sampled: ", len(result))
    ...
    text_file = open(pdbID + ".pdb." + str(window_size) + "." + str(Minimum_Window_Size)+ "."+ str(jobNum), "wt")
